# Title : Machine Problem 11
# Author: John Lawrence H. Castillejo
# Date: 11/03/2022
# Description: Write a MIPS program that defines a one-dimensional array of 10 integers in the static area of the data segment, asks the user to input all 10 array elements, computes, and displays their sum.
# Input: 10 array elements.
# 0utput: The sum of the array elements.
